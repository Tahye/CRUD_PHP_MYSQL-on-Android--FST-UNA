package com.sejad.crud;

/**
 * Created by Ahmed SEJAD on 05/01/2020.
 */
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.card_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                dialog.setMessage("Chargement de données supprimées");
                final CharSequence[] dialogitem = {"Afficher","Modifier","Supprimer"};
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i){
                            ...
                            case 2 :
                                ...
                                builderDel.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_DELETE, new Response.Listener<String>() {
                                            ...
                                            public void onResponse(String response) {
                                                dialog.hide();
                                                dialog.dismiss();
                                                Toast.makeText(view.getContext(),"Donnée supprimée avec succè "+ listItem.getName(),Toast.LENGTH_LONG).show();
